...
async def get_recommendations(
    ...
    body: Optional[RecommendationRequestBody] = Body(default=None),
) -> Any:
    ...
    await db.execute(
        ...
        .values(credit_balance=new_balance, cumulative_credits_spent=new_cumulative, reward_tier=new_tier)
    )

    from src.observability.metrics import CREDIT_TIER_TOTAL, DEVICE_CREDITS_SPENT, DEVICE_CREDIT_BALANCE
    try:
